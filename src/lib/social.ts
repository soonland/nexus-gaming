...
export const generatePlatformUrl = (platform: SocialPlatform, username: string): string | null => {
  const platformUrls: Record<SocialPlatform, ((username: string) => string) | null> = {
    PSN: null,
    XBOX: null,
