...
import { createCompany, deleteCompany, getCompanies, updateCompany } from '../../services/api/companies'
  ...
  return (
    <Box>
      <Flex justifyContent="space-between" alignItems="center" mb={4}>
        <Heading size="md">Sociétés</Heading>
        <Button
          colorScheme="teal"
          leftIcon={<AddIcon />}
        ...
        <Tbody>
          {companies.map((company) => (
            <Tr key={company.id}>
              ...
              <Td>{formatPlatformReleaseDate(company.createdAt)}</Td>
              <Td>
                <IconButton
                  aria-label="Modifier"
                  icon={<EditIcon />}
